document.addEventListener('DOMContentLoaded', () => {
    ...
    exportHistoryBtn.addEventListener('click', () => {
        ...
        const escapeCSV = (content) => {
            ...
            // Because the stored history result might be HTML (due to inline edits preserving markup like <strong>),
            // we should convert it to plain text before exporting so the CSV is clean.
            // A simple reliable way is to use a temporary DOM element.
            let text = content;
    ...
    function loadPreferences() {
        try {
            ...
            if (data) {
                ...
                if (prefs.category) document.getElementById('product-category').value = prefs.category;
                if (prefs.tone) document.getElementById('product-tone').value = prefs.tone;
            }
        } catch (e) {
    ...
    function simulateAIRequest(data, fail = false) {
        return new Promise((resolve, reject) => {
            setTimeout(() => {
                ...
                // Add some randomness to simulate a "new" generation
